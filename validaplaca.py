...
if 6 > len(placa) > 2 and (placa[0] == 'A' or placa[0] == 'P') and placa[1:].isnumeric():
...
elif len(placa) == 7 and placa[:2].isalpha() and placa[3].isnumeric() and placa[4].isalpha() and placa[5:].isnumeric():
